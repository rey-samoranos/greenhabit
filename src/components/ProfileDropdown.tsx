      ...
      >
        ...
        >
          <div className="text-center">
            ...
            {/* User Details */}
            <h3 className="text-2xl font-bold text-white font-spartan mb-2">{userName}</h3>
            <p className="text-green-300 text-sm font-fredoka mb-4">{userEmail}</p>
    ...
    <>
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          ...
          <span className="text-white text-sm font-fredoka hidden md:inline">{userName.split(' ')[0]}</span>
          <svg 
            ...
            <div className="px-4 py-3 border-b border-green-500/30 bg-green-800/20">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-white font-semibold font-spartan text-sm">{userName}</p>
                  <p className="text-green-300 text-xs font-fredoka">{userEmail}</p>
                </div>
              </div>
            </div>
